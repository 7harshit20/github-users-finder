...
class App extends Component {
  ...
  getUserRepos = async (username) => {
    ...
    this.setState({ loading: false, userRepos: res.data });
  }
  ...
  render() {
    ...
    //   // </Fragment>
    // );
    const { loading, users, user, userRepos, alert } = this.state;
          ...
          <div className="container">
            ...
            <Switch>
              ...
              <Route exact path='/user/:login' render={props => (
                <User {...props} getUser={this.getUser} getUserRepos={this.getUserRepos} user={user} userRepos={userRepos} loading={loading} />
              )} />
            </Switch>
          </div>
        </div>
